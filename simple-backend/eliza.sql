INSERT INTO "main"."nlpviewer_backend_project" ("id", "name", "ontology", "user_id", "config") VALUES ('9', 'Eliza', '{
  "name": "base_ontology",
  "definitions": [
    {
