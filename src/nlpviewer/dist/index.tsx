...
var Pagination = require('@material-ui/lab/Pagination');
var Tooltip = require('@material-ui/core/Tooltip');
var styles = require('@material-ui/core/styles');
var IconButton = require('@material-ui/core/IconButton');
var InfoIcon = require('@material-ui/icons/Info');
var MoreVertIcon = require('@material-ui/icons/MoreVert');
...
function Tab(_a) {
    ...
    var _b = __read(React.useState(activeTabIndex || 0), 2), state = _b[0], setState = _b[1];
    return (React__default['default'].createElement("div", { className: style$b.tab_container },
        React__default['default'].createElement("div", { className: style$b.tab_header }, tabs.map(function (tab, i) {
            var isSelected = i === state;
            return (React__default['default'].createElement("div", { key: i, className: style$b.tab_header_button + " " + (isSelected ? style$b.tab_header_button_selected : ''), onClick: function () {
                    setState(i);
                } }, typeof tab.title === 'string' ? tab.title : tab.title()));
        })),
        React__default['default'].createElement("div", { className: style$b.tab_body }, tabs[state] ? tabs[state].body() : null)));
}
...
function Attributes(_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null, Object.keys(attributes).map(function (key) { return (React__default['default'].createElement("div", { className: style$9.attribute, key: key },
        React__default['default'].createElement("div", { className: style$9.attribute_name }, key),
...
function AnnotationDetail(_a) {
    ...
    function renderLinkedAnnotations(annotations, title) {
        ...
        return (React__default['default'].createElement("div", { className: style$8.linked_annotation_container },
            React__default['default'].createElement("strong", null, title),
            annotations.map(function (ann) {
                return (React__default['default'].createElement("span", { key: ann.id, title: ann.id, className: style$8.linked_annotation, onClick: function () {
                        dispatch({
    ...
    return (React__default['default'].createElement("div", { className: style$8.annotation_detail },
        renderLinkedAnnotations(parentAnnotations, '↘ parents'),
        renderLinkedAnnotations(childAnnotations, '↗ children'),
        React__default['default'].createElement("div", { className: style$8.annotation_detail_section },
            React__default['default'].createElement("h2", null, "Attributes"),
            React__default['default'].createElement("div", { className: style$8.annotation_detail_section_body },
                React__default['default'].createElement(Attributes, { attributes: __assign({ id: annotation.id }, annotation.attributes) }))),
        (options && options.allowEditAnnotations) && (React__default['default'].createElement("div", null,
...
function LinkDetail(_a) {
    ...
    return (React__default['default'].createElement("div", null,
        React__default['default'].createElement(Attributes, { attributes: __assign({ id: link.id }, link.attributes) }),
...
function LegendList(_a) {
    ...
    return (React__default['default'].createElement("div", { className: style$7.annotation_legend_container },
        React__default['default'].createElement("ul", { className: style$7.list }, legends.map(function (legend, i) {
            var isSelected = selectedLegendIds.indexOf(legend.entryName) > -1;
            return (React__default['default'].createElement("li", { key: legend.entryName + i },
                React__default['default'].createElement("div", { className: style$7.lengend_container, onClick: function () {
                        isSelected
                            ? dispatch({
                    ...
                    React__default['default'].createElement("input", { type: "checkbox", readOnly: true, checked: isSelected }),
                    ...
                    React__default['default'].createElement("div", { style: {
                        ...
                        React__default['default'].createElement(IconButton__default['default'], { "aria-label": "More" },
                            React__default['default'].createElement(MoreVertIcon__default['default'], { fontSize: "small" })))),
                legend.attributes ? (React__default['default'].createElement("div", { className: style$7.attribute_name_container }, legend.attributes.map(function (attr) {
                    var isSelected = selectedLegendAttributeIds.indexOf(attributeId(legend.entryName, attr.name)) > -1;
                    return (React__default['default'].createElement("div", { className: style$7.attribute_name, key: attr.name, onClick: function () {
                            isSelected
                                ? dispatch({
                        ...
                        React__default['default'].createElement("input", { type: "radio", readOnly: true, checked: isSelected }),
                        attr.name));
                }))) : null));
        }))));
}
...
function TextDetail(_a) {
    ...
    var HtmlTooltip = styles.withStyles(function (theme) { return ({
        tooltip: {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(HtmlTooltip, { title: React__default['default'].createElement(React__default['default'].Fragment, null,
                "Metadata",
                React__default['default'].createElement(Attributes, { attributes: attributes })) },
            React__default['default'].createElement(IconButton__default['default'], { "aria-label": "Info Metadata", style: { marginLeft: 190, marginTop: -55 } },
                React__default['default'].createElement(InfoIcon__default['default'], null))),
        React__default['default'].createElement(LegendList, { legends: __spreadArray(__spreadArray([], __read(annotationLegends)), __read(linkLegends)), selectedLegendIds: selectedLegendIds, selectedLegendAttributeIds: selectedLegendAttributeIds, dispatch: dispatch })));
}
...
function Annotation(_a) {
    ...
    var dispatch = useTextViewerDispatch();
    return (React__default['default'].createElement(React__default['default'].Fragment, null, position.rects.map(function (rect, i) {
        var isConnectPointActive = (linkEditIsDragging || linkEditIsCreating) &&
            linkEditFromEntryId === annotation.id;
        return (React__default['default'].createElement("div", { key: i, className: style$5.annotation_container + "\n              " + (isHighlighted || isSelected
            ...
            React__default['default'].createElement("div", { className: "" + style$5.annotation, style: {
                    marginTop: -2,
                    height: rect.height,
                    width: rect.width + 2,
                ...
                React__default['default'].createElement("div", { className: "" + style$5.annotation_inner_left, style: { borderRightColor: legendColor } }),
                React__default['default'].createElement("div", { className: "" + style$5.annotation_inner_right, style: { borderLeftColor: legendColor } })),
            React__default['default'].createElement("div", { className: style$5.connect_point + "\n              " + (isConnectPointActive && style$5.connect_point_active), style: {
                ...
                React__default['default'].createElement("span", { className: style$5.add_icon }))));
    })));
}
var Annotation$1 = React.memo(Annotation);
...
function LinkSingleLine(_a) {
    ...
    var linkLabel = Object.keys(linkWithPosition.link.attributes)
        ...
        .join(',');
    return (React__default['default'].createElement("div", { className: 'single-line-container', "data-from-id": linkWithPosition.link.fromEntryId, "data-to-id": linkWithPosition.link.toEntryId },
        React__default['default'].createElement("div", { className: style$4.link_line, style: {
                height: height,
        ...
        React__default['default'].createElement("div", { className: style$4.arrow + "\n          " + ((isSelected || isHightlighted) && style$4.arrow_large), style: {
        ...
        linkLabel && !isCollapsed ? (React__default['default'].createElement("div", { className: style$4.link_label, style: {
...
var LinkSingleLine$1 = React.memo(LinkSingleLine);
...
function LinkMultiLine(_a) {
    ...
    var linkLabel = Object.keys(linkWithPosition.link.attributes)
        ...
        .map(function (attrKey) { return linkWithPosition.link.attributes[attrKey]; })
        .join(',');
    return (React__default['default'].createElement("div", { className: "cross-line-container", "data-from-id": linkWithPosition.link.fromEntryId, "data-to-id": linkWithPosition.link.toEntryId },
        React__default['default'].createElement("div", { className: style$4.link_line, style: {
        ...
        fromLineCollapsed ? null : (React__default['default'].createElement("div", { className: style$4.link_label, style: {
                transform: 'translate(-50%)',
                position: 'absolute',
                textAlign: goLeft ? 'left' : 'right',
        ...
        toLineCollapsed ? null : (React__default['default'].createElement("div", { className: style$4.link_label, style: {
                transform: 'translate(-50%)',
                position: 'absolute',
                textAlign: goLeft ? 'left' : 'right',
...
var LinkMultiLine$1 = React.memo(LinkMultiLine);
...
function AnnotationLabel(_a) {
    ...
    return (React__default['default'].createElement("div", { key: annotation.id, className: isSelected ? style$3.annotation_attr_container_selected : '', style: {
            position: 'absolute',
        ...
        return attrKeys.map(function (attrKey, j) {
            return (React__default['default'].createElement("div", { className: isSelected
                    ? style$3.annotation_attr_rect_selected
                    : style$3.annotation_attr_rect, key: attrKey + i, style: __assign({}, (!isSelected && {
                    top: j * 2,
                    left: j * 2,
                })) }, isSelected ? (React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement("span", { className: style$3.annotation_attr_label }, attrKey),
                React__default['default'].createElement("span", { className: style$3.annotation_attr_value }, displayAttributeFloating(annotation.attributes[attrKey])))) : (displayAttributeInline(annotation.attributes[attrKey]))));
        });
    })));
}
var AnnotationLabel$1 = React.memo(AnnotationLabel);
...
function LineWithArrow(_a) {
    ...
    return (React__default['default'].createElement("div", { className: style$2.link_edit_connector, style: {
            position: 'absolute',
            top: y,
            left: x,
            transformOrigin: '0 0',
        ...
        React__default['default'].createElement("span", { className: style$2.link_drag_arrow })));
}
...
function LinkEditConnector(_a) {
    ...
    return React__default['default'].createElement(LineWithArrow, { fromPos: fromPos, toPos: toPos });
}
var LinkEditConnector$1 = React.memo(LinkEditConnector);
...
function TextArea(_a) {
    ...
    var textNodeEl = React.useRef(null);
    ...
    React.useEffect(function () {
        ...
        var handleWindowResize = lodashEs.debounce(function () {
            dispatch({
    ...
    var annotationsWithPosition = React.useMemo(function () {
    ...
    var linksWithPos = React.useMemo(function () {
    ...
    return (React__default['default'].createElement("div", { className: textAreaClass, style: {
            userSelect: linkEditIsCreating ? 'none' : 'auto',
            cursor: annoEditIsCreating ? 'text' : 'initial',
        }, ref: textAreaEl },
        React__default['default'].createElement("div", { className: style$6.text_node_container, ref: textNodeEl }, spacedText || text),
        React__default['default'].createElement("div", { className: style$6.annotations_container, style: {
            ...
            return (React__default['default'].createElement(Annotation$1, { key: i, annotation: ann.annotation, isSelected: ann.annotation.id === selectedAnnotationId, isHighlighted: highlightedAnnotationIds.indexOf(ann.annotation.id) > -1 ||
        ...
        React__default['default'].createElement("div", { className: "ann_edit_rects_container" },
            annoEditRangeRects.map(function (rect, i) {
                return (React__default['default'].createElement("div", { key: i, className: style$6.ann_edit_rect, style: {
            ...
            annoEditBeginRect && (React__default['default'].createElement("div", { className: style$6.annotation_text_selection_cursor, style: {
                ...
                React__default['default'].createElement("span", { className: style$6.cursor }))),
            annoEditEndRect && (React__default['default'].createElement("div", { className: style$6.annotation_text_selection_cursor, style: {
                ...
                React__default['default'].createElement("span", { className: style$6.cursor })))),
        React__default['default'].createElement("div", { className: "annotation_line_toggles_container", style: {
                pointerEvents: annoEditIsCreating ? 'none' : 'initial',
            ...
            return (React__default['default'].createElement("button", { key: i, onClick: isCollapsed ? uncollapse : collapse, className: style$6.annotation_line_toggle, style: { top: lineHeight } }, isCollapsed ? '+' : '-'));
        })),
        React__default['default'].createElement("div", { className: "annotation_label_container", style: {
                pointerEvents: annoEditIsCreating ? 'none' : 'initial',
            } }, annotationsWithPosition.map(function (ann) {
            var isSelected = ann.annotation.id === selectedAnnotationId;
            return (React__default['default'].createElement(AnnotationLabel$1, { key: ann.annotation.id, position: ann.position, annotation: ann.annotation, isSelected: isSelected, selectedLegendAttributeIds: selectedLegendAttributeIds }));
        })),
        React__default['default'].createElement("div", { className: style$6.links_container, style: {
                pointerEvents: annoEditIsCreating ? 'none' : 'initial',
            ...
            if (linkPos.fromLinkY === linkPos.toLinkY) {
                ...
                return (React__default['default'].createElement(LinkSingleLine$1, { key: linkPos.link.id, linkWithPosition: linkPos, isSelected: isLinkSelected, isHightlighted: isLinkHightlighted, isCollapsed: isLineCollapsed, linkHeight: linkHeight, selectedLegendAttributeIds: selectedLegendAttributeIds }));
            }
            else {
                return (React__default['default'].createElement(LinkMultiLine$1, { key: linkPos.link.id, linkWithPosition: linkPos, isSelected: isLinkSelected, isHightlighted: isLinkHightlighted, linkHeight: linkHeight, selectedLegendAttributeIds: selectedLegendAttributeIds, collapsedLineIndexes: collapsedLineIndexes, lineHeights: lineHeights, lineStartX: lineStartX, lineWidth: lineWidth }));
            }
        })),
        React__default['default'].createElement(ConnectorContainer, { linkEditIsDragging: linkEditIsDragging, textNodeEl: textNodeEl.current, annotationsWithPosition: annotationsWithPosition, linkEditFromEntryId: linkEditFromEntryId }),
        React__default['default'].createElement(LineWithArrowContainer, { linkEditIsCreating: linkEditIsCreating, linkEditIsDragging: linkEditIsDragging, linkEditFromEntryId: linkEditFromEntryId, linkEditToEntryId: linkEditToEntryId, annotationsWithPosition: annotationsWithPosition })));
}
function LineWithArrowContainer(_a) {
    ...
    if (linkEditIsCreating &&
        ...
        return (React__default['default'].createElement("div", { className: style$6.link_edit_container },
            React__default['default'].createElement(LineWithArrow, { fromPos: fromPos, toPos: toPos })));
    }
    else {
        return null;
    }
...
function ConnectorContainer(_a) {
    ...
    if (!startAnnotation)
        return null;
    return (React__default['default'].createElement("div", { className: style$6.link_edit_container },
        React__default['default'].createElement(LinkEditConnector$1
...
function ScopeSelector(_a) {
    ...
    return (React__default['default'].createElement(Select__default['default'], { className: style$1.input, value: selectedLegendTypeOptions, onChange: function (item) {
            dispatch({
                type: 'set-scope',
                scopeId: item.value,
            });
...
function LinkCreateBox(_a) {
    ...
    var _c = __read(React.useState(false), 2), slideInAnimated = _c[0], setSlideInAnimated = _c[1];
    var _d = __read(React.useState(false), 2), flashAnimated = _d[0], setFlashAnimated = _d[1];
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var _e = __read(React.useState({}), 2), enteredAttribute = _e[0], setEnteredAttribute = _e[1];
    React.useEffect(function () {
    ...
    function renderLegendSelect() {
        ...
        return (React__default['default'].createElement("div", { className: style.legend_type_container },
            React__default['default'].createElement("div", { className: style.legend_type_title }, "Legend Type"),
            legendTypeOptions.length ? (React__default['default'].createElement(Select__default['default'], { value: selectedLegendTypeOption, onChange: function (item) {
    ...
    return (React__default['default'].createElement("div", { className: style.create_box + "\n      " + (slideInAnimated && style.slide_in_animated) },
        React__default['default'].createElement("div", { className: style.create_entry_container },
            React__default['default'].createElement("div", { className: style.create_title }, "Parent"),
            React__default['default'].createElement("div", { className: style.create_id, onClick: function () {
        ...
        React__default['default'].createElement("div", { className: style.create_entry_container + "\n          " + (flashAnimated ? style.flash_animated_on : style.flash_animated_off) },
            React__default['default'].createElement("div", { className: style.create_title }, "Child"),
            React__default['default'].createElement("div", { className: style.create_id + "\n          " + (!toEntryId && style.to_be_select), onClick: function () {
                    if (fromEntryId && toEntryId) {
                        dispatch({
                            type: 'select-annotation',
        ...
        selectedLegendDefinition &&
            ...
            selectedLegendDefinition.attributes.length && (React__default['default'].createElement("div", { className: style.legend_attributes }, (selectedLegendDefinition.attributes || []).map(function (attr) {
            return (React__default['default'].createElement("div", { className: style.legend_attribute_item, key: attr.name },
                React__default['default'].createElement("div", { className: style.legend_attribute_item_title }, attr.name),
                React__default['default'].createElement("div", null,
                    React__default['default'].createElement("input", { type: "text", value: enteredAttribute[attr.name] || '', onChange: function (e) {
                            var _a;
                            return setEnteredAttribute(__assign(__assign({}, enteredAttribute), (_a = {}, _a[attr.name] = e.target.value, _a)));
                        } }))));
        }))),
        React__default['default'].createElement("div", { className: style.buttons },
            React__default['default'].createElement("button", { onClick: function () {
                    dispatch({
...
function AnnotationCreateBox(_a) {
    ...
    var _b = __read(React.useState(false), 2), slideInAnimated = _b[0], setSlideInAnimated = _b[1];
    var _c = __read(React.useState(false), 2), flashAnimated = _c[0], setFlashAnimated = _c[1];
    var _d = __read(React.useState({}), 2), enteredAttribute = _d[0], setEnteredAttribute = _d[1];
    React.useEffect(function () {
        setSlideInAnimated(true);
    }, []);
    React.useEffect(function () {
    ...
    function renderAttributeSelect() {
        ...
        return (React__default['default'].createElement("div", { className: style.legend_attributes }, (selectedLegendDefinition.attributes || []).map(function (attr) {
            return (React__default['default'].createElement("div", { className: style.legend_attribute_item, key: attr.name },
                React__default['default'].createElement("div", { className: style.legend_attribute_item_title }, attr.name),
    ...
    function renderAttributeInput(attr, attrConstraint) {
        if (attrConstraint[attr.name]) {
            ...
            return (React__default['default'].createElement("div", null,
                React__default['default'].createElement(Select__default['default'], { className: style.input, value: selectedOption, onChange: function (item) {
                        var _a;
            ...
            return (React__default['default'].createElement("div", null,
                React__default['default'].createElement("input", { type: "text", className: style.input, value: enteredAttribute[attr.name] || '', onChange: function (e) {
                        var _a;
                        return setEnteredAttribute(__assign(__assign({}, enteredAttribute), (_a = {}, _a[attr.name] = e.target.value, _a)));
                    } })));
        }
    ...
    return (React__default['default'].createElement("div", { className: style.create_box + "\n      " + (slideInAnimated && style.slide_in_animated) },
        React__default['default'].createElement("div", { className: style.create_entry_container },
            React__default['default'].createElement("div", { className: style.create_title }, "Begin"),
            React__default['default'].createElement("div", { className: style.create_id }, cursorBegin !== null ? cursorBegin : '')),
        React__default['default'].createElement("div", { className: style.create_entry_container + "\n          " + (flashAnimated ? style.flash_animated_on : style.flash_animated_off) },
            React__default['default'].createElement("div", { className: style.create_title }, "End"),
            React__default['default'].createElement("div", { className: style.create_id + "\n          " + (cursorEnd === null && style.to_be_select) }, cursorEnd !== null ? cursorEnd : '[Click text to select end]')),
        React__default['default'].createElement("div", { className: style.legend_type_container },
            React__default['default'].createElement("div", { className: style.legend_type_title }, "Legend Type"),
            React__default['default'].createElement(Select__default['default'], { value: selectedLegendTypeOption, onChange: function (item) {
                    var selectedItem = item;
                    dispatch({
...
function TextViewer(_a) {
    ...
    function renderPlugin(p) {
        ...
        return (React__default['default'].createElement(Comp, { key: 'plugin_' + p.name, dispatch: dispatch, appState: appState }));
    }
    ...
    function renderAllPlugin() {
        ...
        if (enabledPlugins.length === 0) {
            return (React__default['default'].createElement("div", { className: style$a.plugins_container }, "No Plugins Configured."));
        }
            ...
            return (React__default['default'].createElement("div", { className: style$a.plugins_container },
                React__default['default'].createElement(Tab, { tabs: tabList, activeTabIndex: 0 })));
        }
        return null;
    }
    function customRender(areaName) {
        ...
        return React__default['default'].createElement("span", null, "Invalid component");
    }
    function MiddleCenterArea() {
        ...
        if (typeof projectConfig['layoutConfigs'][areaName] === 'undefined' ||
            ...
            if (textPack) {
                return (React__default['default'].createElement(TextArea, { textPack: textPack, annotationLegendsColored: annotationLegendsWithColor }));
            }
        }
    ...
    function LeftArea() {
        ...
        if (typeof projectConfig['layoutConfigs'][areaName] === 'undefined' ||
            ...
            if (textPack && ontology) {
                return (React__default['default'].createElement("div", { className: style$a.metadata_side_container },
                    React__default['default'].createElement("h1", { className: style$a.anno_legends_heading }, "Annotation Legends"),
                    React__default['default'].createElement("div", { className: style$a.anno_legends_sub },
                        React__default['default'].createElement("p", null,
                            "See the summary visualiations of annotations and explore them in-situ.",
                            React__default['default'].createElement("br", null),
                            " Select edit to change them.")),
                    (options && options.allowEditAnnotations) && (React__default['default'].createElement("div", { className: style$a.add_annotation_container },
                        React__default['default'].createElement(core.FormControlLabel, { control: React__default['default'].createElement(Checkbox__default['default'], { icon: React__default['default'].createElement(CheckBoxOutlineBlankIcon__default['default'], { fontSize: "small" }), checkedIcon: React__default['default'].createElement(CheckBoxIcon__default['default'], { fontSize: "small", htmlColor: "#246ED6" }), size: "small", checked: annoEditIsCreating, onChange: function () {
                                    dispatch({
                        ...
                        annoEditIsCreating && (React__default['default'].createElement("div", { className: style$a.button_action_description }, "select text to add annotation")))),
                    React__default['default'].createElement(TextDetail, { annotationLegends: annotationLegendsWithColor, linkLegends: linksLegendsWithColor, attributes: attributes })));
            }
        }
        return customRender(areaName);
    }
    function RightArea() {
        ...
        if (typeof projectConfig['layoutConfigs'][areaName] === 'undefined' ||
            ...
            if (textPack && ontology) {
                return (React__default['default'].createElement("div", { className: style$a.attributes_side_container },
                    linkEditIsCreating && (React__default['default'].createElement("div", null,
                        React__default['default'].createElement("h2", null, "Create Link"),
                        React__default['default'].createElement(LinkCreateBox, { fromEntryId: linkEditFromEntryId, toEntryId: linkEditToEntryId, ontology: ontology, onEvent: onEvent }))),
                    annoEditIsCreating && annoEditCursorBegin !== null && (React__default['default'].createElement("div", { className: style$a.link_edit_container },
                        React__default['default'].createElement(AnnotationCreateBox, { cursorBegin: annoEditCursorBegin, cursorEnd: annoEditCursorEnd, ontology: ontology, onEvent: onEvent }))),
                    selectedLink && (React__default['default'].createElement("div", null,
                        React__default['default'].createElement("h2", null, "Link Attributes"),
                        React__default['default'].createElement(LinkDetail, { link: selectedLink, onEvent: onEvent }))),
                    selectedAnnotation && (React__default['default'].createElement("div", null,
                        React__default['default'].createElement("h2", null, "Annotation Attributes"),
                        React__default['default'].createElement(AnnotationDetail, { parentAnnotations: selectedAnnotationParents, childAnnotations: selectedAnnotationChildren, annotation: selectedAnnotation, onEvent: onEvent })))));
            }
        }
        return customRender(areaName);
    }
    function ToolBar() {
        ...
        if (typeof projectConfig['layoutConfigs']['center-middle'] === 'undefined' ||
            ...
            if (textPack && ontology && projectConfig) {
                return (React__default['default'].createElement("div", { className: style$a.tool_bar_container },
                    React__default['default'].createElement("div", { className: style$a.scope_selector_container },
                        React__default['default'].createElement(ScopeSelector, { ontology: ontology, selectedScopeId: selectedScopeId, scopeConfig: projectConfig.scopeConfigs }),
                        (selectedScopeId !== null ||
                            (selectedScopeId === null &&
                                documents &&
                                documents.documents.length > 1)) && (React__default['default'].createElement("div", { className: style$a.scope_nav_container },
                            React__default['default'].createElement(Pagination__default['default'], { page: paginationIndex + 1, onChange: handlePageChange, count: scopeCount, defaultPage: 1, variant: "outlined", shape: "rounded" }))))));
            }
        }
        if (projectConfig['layoutConfigs']['center-middle'] === 'example') {
            return React__default['default'].createElement("span", null, "Example component");
        }
        return React__default['default'].createElement("div", null);
    }
    return (React__default['default'].createElement("div", { className: style$a.text_viewer },
        React__default['default'].createElement("main", { className: style$a.layout_container },
            LeftArea(),
            React__default['default'].createElement("div", { className: style$a.center_area_container + "\n              " + (annoEditIsCreating && style$a.is_adding_annotation) },
                ((options && options.enableScopeSelector) && (React__default['default'].createElement(ToolBar, null))),
                React__default['default'].createElement("div", { className: "" + style$a.text_area_container }, MiddleCenterArea()),
                MiddleBottomArea()),
            RightArea())));
}
...
function NLPViewer(props) {
    return (React__default['default'].createElement(TextViewerProvider, null,
        React__default['default'].createElement(TextViewerFetchContainer, __assign({}, props)),
        ";"));
}
function TextViewerFetchContainer(props) {
    ...
    return (React__default['default'].createElement(TextViewer, { plugins: props.plugins, onEvent: props.onEvent, projectConfig: props.projectConfig, documents: props.documents, options: props.options }));
}

exports.TextViewerProvider = TextViewerProvider;
exports.default = NLPViewer;
exports.getState = getState;
exports.transformBackAnnotation = transformBackAnnotation;
exports.transformBackLink = transformBackLink;
exports.transformDocs = transformDocs;
exports.transformPack = transformPack;
exports.transformProjectConfig = transformProjectConfig;
exports.useTextViewerDispatch = useTextViewerDispatch;
exports.useTextViewerState = useTextViewerState;
